...
class AdminConversationsUnarchiveSchema(object):
    """Implementation of the 'admin.conversations.unarchive schema' model.
    ...
    def __init__(
        ...
        """Initialize a AdminConversationsUnarchiveSchema instance."""
