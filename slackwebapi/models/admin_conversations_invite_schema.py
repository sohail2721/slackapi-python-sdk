...
class AdminConversationsInviteSchema(object):
    """Implementation of the 'admin.conversations.invite schema' model.
    ...
    def __init__(
        ...
        """Initialize a AdminConversationsInviteSchema instance."""
