...
class ChatDeleteScheduledMessageSchema(object):
    """Implementation of the 'chat.deleteScheduledMessage schema' model.
    ...
    def __init__(
        ...
        """Initialize a ChatDeleteScheduledMessageSchema instance."""
