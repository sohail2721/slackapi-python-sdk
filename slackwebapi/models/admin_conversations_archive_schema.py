...
class AdminConversationsArchiveSchema(object):
    """Implementation of the 'admin.conversations.archive schema' model.
    ...
    def __init__(
        ...
        """Initialize a AdminConversationsArchiveSchema instance."""
