...
class ConversationsKickSuccessSchema(object):
    """Implementation of the 'conversations.kick success schema' model.
    ...
    def __init__(
        ...
        """Initialize a ConversationsKickSuccessSchema instance."""
