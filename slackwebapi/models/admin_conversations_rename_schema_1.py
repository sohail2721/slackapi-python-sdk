...
class AdminConversationsRenameSchema1(object):
    """Implementation of the 'admin.conversations.rename schema1' model.
    ...
    def __init__(
        ...
        """Initialize a AdminConversationsRenameSchema1 instance."""
