...
class AdminConversationsRenameSchema(object):
    """Implementation of the 'admin.conversations.rename schema' model.
    ...
    def __init__(
        ...
        """Initialize a AdminConversationsRenameSchema instance."""
