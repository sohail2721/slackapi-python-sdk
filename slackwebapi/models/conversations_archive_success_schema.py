...
class ConversationsArchiveSuccessSchema(object):
    """Implementation of the 'conversations.archive success schema' model.
    ...
    def __init__(
        ...
        """Initialize a ConversationsArchiveSuccessSchema instance."""
