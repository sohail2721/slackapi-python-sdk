...
class AdminConversationsDeleteSchema(object):
    """Implementation of the 'admin.conversations.delete schema' model.
    ...
    def __init__(
        ...
        """Initialize a AdminConversationsDeleteSchema instance."""
