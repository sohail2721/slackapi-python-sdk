...
class AppsPermissionsRequestSchema(object):
    """Implementation of the 'apps.permissions.request schema' model.
    ...
    def __init__(
        ...
        """Initialize a AppsPermissionsRequestSchema instance."""
