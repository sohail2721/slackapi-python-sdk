...
class ConversationsUnarchiveSuccessSchema(object):
    """Implementation of the 'conversations.unarchive success schema' model.
    ...
    def __init__(
        ...
        """Initialize a ConversationsUnarchiveSuccessSchema instance."""
