...
class ConversationsMarkSuccessSchema(object):
    """Implementation of the 'conversations.mark success schema' model.
    ...
    def __init__(
        ...
        """Initialize a ConversationsMarkSuccessSchema instance."""
