...
class CallsParticipantsController(BaseController):
    ...
    def __init__(self, config):
        """Initialize CallsParticipantsController object."""
        super(CallsParticipantsController, self).__init__(config)

    def calls_participants_add(self,
                               token,
                               id,
                               users):
        """Perform a POST request to /calls.participants.add.
        ...
        Args:
            ...
            users (str): The list of users to add as participants in the Call. [Read
    ...
    def calls_participants_remove(self,
                                  ...
                                  id,
                                  users):
        """Perform a POST request to /calls.participants.remove.
        ...
        Args:
            token (str): Authentication token. Requires scope: `calls:write`
            id (str): `id` returned by the [`calls.add`](/methods/calls.add) method.
            users (str): The list of users to remove as participants in the Call.
