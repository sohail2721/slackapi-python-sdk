...
class AdminAppsRestrictedController(BaseController):
    ...
    def __init__(self, config):
        """Initialize AdminAppsRestrictedController object."""
        super(AdminAppsRestrictedController, self).__init__(config)
    ...
    def admin_apps_restricted_list(self,
                                   ...
                                   team_id=None,
                                   enterprise_id=None):
        """Perform a GET request to /admin.apps.restricted.list.
